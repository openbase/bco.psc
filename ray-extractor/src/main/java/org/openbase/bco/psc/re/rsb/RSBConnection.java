...
public class RSBConnection {
    ...
    private Informer<PointingRay3DFloatDistributionCollection> informer;
     ...
     */
    public void sendPointingRays(PointingRay3DFloatDistributionCollection rays) throws CouldNotPerformException{
        try {
            LOGGER.trace("Sending pointing rays via RSB.");
            informer.publish(rays);
        } catch (RSBException ex) {
